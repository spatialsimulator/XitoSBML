...
public class ImagePlus implements ImageObserver, Measurements, Cloneable {
	...
	/** The default 16 bit display range. */
	private static int default16bitDisplayRange;
	
	/** The antialias rendering. */
	 ...
	 *
	 * @param channels the new active channels
	 */ 
	...
	/**
	 * Checks if is processor.
	 *
	 * @return true, if is processor
	 */
	 ...
	 *
	 * @return true, if is displayed hyper stack
	 */
	...
	/**
	 * Checks if is dicom tag.
	 *
	 * @param key the key
	 * @return true, if is dicom tag
	 */
	 ...
	 *
	 * @param slice the new current slice
	 */
	 ...
	 *
	 * @param n the new slice without update
	 */
	 ...
	 *
	 * @param newRoi the new roi
	 * @param updateDisplay the update display
	 */
	...
	/**
	 * Sets the ignore flush.
	 *
	 * @param ignoreFlush the new ignore flush
	 */
    ...
    */
     ...
     *
     * @param global the new global calibration
     */
    ...
    */
	...
	/**
	 * Gets the FFT location.
	 *
	 * @param x the x
	 * @param y the y
	 * @param cal the cal
	 * @return the FFT location
	 */
	...
	/**
	 * Sets the open as hyper stack.
	 *
	 * @param openAsHyperStack the new open as hyper stack
	 */
	...
	/**
	 * Gets the open as hyper stack.
	 *
	 * @return the open as hyper stack
	 */
	...
	/**
	 * Gets the display range min.
	 *
	 * @return the display range min
	 */
	...
	/**
	 * Gets the display range max.
	 *
	 * @return the display range max
	 */
     ...
     *
     * @param bitDepth the new default 16 bit range
     */
     ...
     *
     * @return the default 16 bit range
     */
	...
	/**
	 * Sets the hide overlay.
	 *
	 * @param hide the new hide overlay
	 */
	...
	/**
	 * Gets the hide overlay.
	 *
	 * @return the hide overlay
	 */
	 ...
	 *
	 * @param antialiasRendering the new antialias rendering
	 */
