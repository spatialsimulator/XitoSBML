...
public class CurveFitter implements UserFunction{
	 ...
	 *
	 * @param initialParams the new initial parameters
	 */
	 ...
	 *
	 * @param maxRestarts the new restarts
	 */
	 ...
	 *
	 * @param maxIter the new max iterations
	 */
...
//IJ.log(IJ.d2s(params[0],3,5)+","+IJ.d2s(params[1],3,5)+": r="+IJ.d2s(sumResidualsSqr,3,5)+Thread.currentThread().getName() );
	 ...
	 *
	 * @param params the params
	 * @param forRegression the for regression
	 */
	 ...
	 *
	 * @return the offset and factor params
	 */
	 ...
	 *
	 * @param fitType the fit type
	 * @return true, if is modified fit type
	 */
