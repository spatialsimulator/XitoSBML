...
public class Minimizer {
    ...
    /** The num completed minimizations. */
     ...
     *
     * @return the completed minimizations
     */
     ...
     *
     * @param maxRelError the new max error
     */
     ...
     *
     * @param maxRelError the max rel error
     * @param maxAbsError the max abs error
     */
     ...
     *
     * @param paramResolutions the new param resolutions
     */
     ...
     *
     * @param numThreads the new maximum threads
     */
     ...
     *
     * @param numExtraArrayElements the new extra array elements
     */
     ...
     * @param initialParamVariations the initial param variations
     * @param seed the seed
     */
     ...
     * @param worstVertex the worst vertex
     * @param howFar the how far
     * @param newVertex the new vertex
     * @return the vertex and evaluate
     */
     ...
     *
     * @param simp the simp
     * @param excludeVertex the exclude vertex
     * @param center the center
     * @return the center
     */
     ...
     *
     * @param simp the simp
     * @param bestVertexNumber the best vertex number
     * @param paramVariations the param variations
     * @param random the random
     * @return true, if successful
     */
     ...
     *
     * @param simp the simp
     * @param worstNextBestArray the worst next best array
     */
