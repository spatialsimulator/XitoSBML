...
public class ImageCanvas extends Canvas implements MouseListener, MouseMotionListener, Cloneable {
    ...
    /** The mouse pressed time. */
    private long mousePressedTime;
    
    /** The over overlay label. */
	...
	/** The off screen width. */
	private int offScreenWidth = 0;
	
	/** The off screen height. */
	 ...
	 * Sets the src rect.
	 *
	 * @param srcRect the new src rect
	 */
	...
	/**
	 * Sets the paint pending.
	 *
	 * @param state the new paint pending
	 */
	...
	/**
	 * Gets the paint pending.
	 *
	 * @return the paint pending
	 */
    ...
    */
	...
	/**
	 * Sets the magnification 2.
	 *
	 * @param magnification the new magnification 2
	 */
	...
	/**
	 * Gets the lower zoom level.
	 *
	 * @param currentMag the current mag
	 * @return the lower zoom level
	 */
	...
	/**
	 * Gets the higher zoom level.
	 *
	 * @param currentMag the current mag
	 * @return the higher zoom level
	 */
	 ...
	 * @param ox the ox
	 * @param oy the oy
	 * @param setBackground the set background
	 */
	...
	*/
	...
	/**
	 * Sets the show all list.
	 *
	 * @param showAllList the new show all list
	 */
	...
	/**
	 * Gets the show all list.
	 *
	 * @return the show all list
	 */
	 ...
	 *  Obsolete.
	 *
	 * @param showAllROIs the new show all RO is
	 */
	 ...
	 *  Obsolete.
	 *
	 * @param c the new show all color
	 */
	 ...
	 *
	 * @param list the new display list
	 ...
	 *
	 * @param customRoi the new custom roi
	 */
	 ...
	 *
	 * @param status the new show cursor status
	 */
	 ...
	 *
	 * @param scaleToFit the new scale to fit
	 */
	...
	/**
	 * Gets the scale to fit.
	 *
	 * @return the scale to fit
	 */
