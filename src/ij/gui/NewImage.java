...
public class NewImage {
	...
	/**
	 * Creates the unsigned short image.
	 *
	 * @param title the title
	 * @param width the width
	 * @param height the height
