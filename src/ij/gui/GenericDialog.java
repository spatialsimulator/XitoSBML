...
FocusListener, ItemListener, KeyListener, AdjustmentListener, WindowListener {
	...
	*/
     ...
     *
     * @param echoChar the new echo char
     */
   ...
   */
	...
	*/
     ...
     *
     * @param label the new cancel label
     */
     ...
     *
     * @param label the new help label
     */
     ...
     *
     * @param smartRecording the new smart recording
     */
   ...
   public String getNextString() {
	 ...
	 */
	   ...
	   *
	   * @return the radio button groups
	   */
     ...
     *
     * @return true, if is preview active
     */
