...
public class StackWindow extends ImageWindow implements Runnable, AdjustmentListener, ActionListener, MouseWheelListener {
	...
	/**
	 * Instantiates a new stack window.
	 *
	 * @param imp the imp
	 */
	...
	/* (non-Javadoc)
	 * @see ij.gui.ImageWindow#mouseWheelMoved(java.awt.event.MouseWheelEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.gui.ImageWindow#createSubtitle()
	 */
    ...
    /**
     * Gets the n scrollbars.
     *
     * @return the n scrollbars
     */
