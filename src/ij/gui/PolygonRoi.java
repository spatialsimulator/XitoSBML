...
public class PolygonRoi extends Roi {
	...
	/**
	 * Instantiates a new polygon roi.
	 *
	 * @param xPoints the x points
	 * @param yPoints the y points
	 * @param nPoints the n points
	 ...
	 * @param fill the fill
	 * @param isActiveOverlayRoi the is active overlay roi
	 */
   ...
   void updateClipRectAndDraw() {
	...
	/**
	 * Gets the angle as string.
	 *
	 * @return the angle as string
	 */
   ...
   protected void mouseDownInHandle(int handle, int sx, int sy) {
	 ...
	 * Fit spline.
	 *
	 * @param evaluationPoints the evaluation points
	 */
	 ...
	 *
	 * @return the smoothed line length
	 */
	...
	/**
	 * Gets the float smoothed line length.
	 *
	 * @return the float smoothed line length
	 */
	...
	/**
	 * Gets the float smoothed perimeter.
	 *
	 * @return the float smoothed perimeter
	 */
	...
	/**
	 * Gets the non spline coordinates.
	 *
	 * @return the non spline coordinates
	 */
	...
	/**
	 * Gets the non spline float polygon.
	 *
	 * @return the non spline float polygon
	 */
	...
	/* (non-Javadoc)
	 * @see ij.gui.Roi#subPixelResolution()
	 */
	...
	/* (non-Javadoc)
	 * @see ij.gui.Roi#getInterpolatedPolygon(double, boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.gui.Roi#setLocation(double, double)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.gui.Roi#enableSubPixelResolution()
	 */
