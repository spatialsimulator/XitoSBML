...
public class ProfilePlot {
	...
	/** The Constant ASPECT_RATIO. */
	static final double ASPECT_RATIO = 0.5;
	
	/** The max. */
	private double min, max;
	
	/** The min and max calculated. */
	...
	/**
	 * Instantiates a new profile plot.
	 */
	public ProfilePlot() {
	}
	 ...
	 *
	 * @param imp the imp
	 * @param averageHorizontally the average horizontally
	 */
	...
	/**
	 * Gets the straight line profile.
	 *
	 * @param roi the roi
	 * @param cal the cal
	 * @param ip the ip
	 * @return the straight line profile
	 */
	...
	/**
	 * Gets the row average profile.
	 *
	 * @param rect the rect
	 * @param cal the cal
	 * @param ip the ip
	 * @return the row average profile
	 */
	...
	/**
	 * Gets the column average profile.
	 *
	 * @param rect the rect
	 * @param ip the ip
	 * @return the column average profile
	 */
	...
	/**
	 * Gets the irregular profile.
	 *
	 * @param roi the roi
	 * @param ip the ip
	 * @param cal the cal
	 * @return the irregular profile
	 */
	...
	/**
	 * Gets the wide line profile.
	 *
	 * @param imp the imp
	 * @param lineWidth the line width
	 * @return the wide line profile
	 */
