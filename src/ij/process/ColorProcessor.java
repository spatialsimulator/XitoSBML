...
public class ColorProcessor extends ImageProcessor {
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#createImage()
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#setColorModel(java.awt.image.ColorModel)
	 */
   ...
   public void noise(double range) {
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#medianFilter()
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#findEdges()
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#erode()
	 */
	public void erode() {
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#dilate()
	 */
	public void dilate() {
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#autoThreshold()
	 */
	 ...
	 * @param x the x
	 * @param y the y
	 * @return the interpolated RGB pixel
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#getHistogram()
	 */
	 ...
	 *
	 * @param rFactor the r factor
	 * @param gFactor the g factor
	 ...
	 *
	 * @param rweight the rweight
	 * @param gweight the gweight
	 * @param bweight the bweight
	 */
	 ...
	 *
	 * @return true, if is inverted lut
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#updateComposite(int[], int)
	 */
