...
public abstract class ImageProcessor implements Cloneable {
	 ...
	 *
	 * @return true, if is pseudo color lut
	 */
	 ...
	 * @param lutUpdate the lut update
	 */
	 ...
	 *
	 * @param mString the new auto threshold
	 */
	 ...
	 * @param darkBackground the dark background
	 * @param lutUpdate the lut update
	 */
	...
	*/
	 ...
	 * @param x the x
	 * @param y the y
	 * @param rwidth the rwidth
	 * @param rheight the rheight
	 * @see ImageProcessor#resetRoi
	 */
	...
	/**
	 * Gets the interpolation methods.
	 *
	 ...
	 *
	 * @param antialiasedText the new antialiased text
	 */
	...
	*/
	 ...
	 *
	 * @param cTable the new calibration table
	 ...
	 *
	 * @param size the new histogram size
	 */
	...
	/**
	 * Gets the bilinear interpolated pixel.
	 *
	 * @param x the x
	 * @param y the y
	...
	*/	
	...
	/**
	 * Gets the interpolated edge value.
	 *
	 * @param x the x
	 * @param y the y
	 * @return the interpolated edge value
	 */
	...
	*/
	 ...
	 *
	 * @param pixels the new snapshot pixels
	 */
	 ...
	 * @param xOffset the x offset
	 * @param yOffset the y offset
	 * @param eraseBackground the erase background
	 ...
	 * 		of the image.
	 *
	 * @param lutAnimation the new lut animation
	 */
	...
	*/
	...
	/**
	 * Gets the index sample model.
	 *
	 * @return the index sample model
	 */
	 ...
	 * 		snapshot buffer if it is not null and 'snapshotCopyMode' is true.
	 *
	 * @param b the new snapshot copy mode
	...
	*/
	 ...
	 *
	 * @param rgbPixels the rgb pixels
	...
	/**
	 * Sets the use bicubic.
	 *
	 * @param b the new use bicubic
	 */
	 ...
	 *
	 * @param slice the new slice number
	 */
