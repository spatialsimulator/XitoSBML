...
public class StackStatistics extends ImageStatistics {
	...
	/**
	 * Instantiates a new stack statistics.
	 *
	 * @param imp the imp
	 */
     ...
     * @param imp the imp
     * @param bins the bins
     * @param histogramMin the histogram min
     * @param histogramMax the histogram max
     */
	...
	/**
	 * Gets the raw 16 bit min and max.
	 *
	 * @param hist the hist
	 * @param minThreshold the min threshold
	 * @param maxThreshold the max threshold
	 * @return the raw 16 bit min and max
	 */
	...
	/**
	 * Gets the 16 bit statistics.
	 *
	 * @param hist the hist
	 * @param min the min
	 * @param max the max
	 * @return the 16 bit statistics
	 */
