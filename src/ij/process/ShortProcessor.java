...
public class ShortProcessor extends ImageProcessor {
	...
	/**
	 * Instantiates a new short processor.
	 *
	 * @param width the width
	 * @param height the height
	 * @param pixels the pixels
	 ...
	 * @deprecated 16 bit images are normally unsigned but signed images can be simulated by
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#create8BitImage()
	 */
	 ...
	 *
	 * @return the 16 bit buffered image
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#snapshot()
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#reset()
	 */
	public void reset() {
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#reset(ij.process.ImageProcessor)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#setSnapshotPixels(java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#getSnapshotPixels()
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#getPixel(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#get(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#set(int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#get(int)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#set(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#getf(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#setf(int, int, float)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#getf(int)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#setf(int, float)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#getPixelInterpolated(double, double)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#setPixels(java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#invert()
	 */
	public void invert() {
		resetMinAndMax();
		process(INVERT, 0.0);
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#flipVertical()
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#crop()
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#setThreshold(double, double, int)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#threshold(int)
	 */
	...
	*/
	...
	/* (non-Javadoc)
	 * @see ij.process.ImageProcessor#getBitDepth()
	 */
