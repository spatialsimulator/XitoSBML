...
public class ByteProcessor extends ImageProcessor {
	...
	final public int getPixelInterpolated(double x, double y) {
 	...
 	/* (non-Javadoc)
	  * @see ij.process.ImageProcessor#getPixelValue(int, int)
	  */
    ...
    /* (non-Javadoc)
     * @see ij.process.ImageProcessor#convolve3x3(int[])
     */
	...
	/**
	 * Gets the edge pixel 1.
	 *
	 * @param pixels2 the pixels 2
	 * @param foreground the foreground
	 * @param x the x
	 * @param y the y
	 * @return the edge pixel 1
	 */
	...
	/**
	 * Gets the edge pixel 0.
	 *
	 * @param pixels2 the pixels 2
	 * @param background the background
	 * @param x the x
	 * @param y the y
	 * @return the edge pixel 0
	 */
	...
	/**
	 * Sets the from float processors.
	 *
	 * @param fp the new from float processors
	 */
	...
	/**
	 * Sets the from float arrays.
	 *
	 * @param arrays the new from float arrays
	 */
