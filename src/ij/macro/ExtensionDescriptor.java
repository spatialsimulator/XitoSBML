...
public class ExtensionDescriptor {
  ...
  /**
   * Instantiates a new extension descriptor.
   *
   * @param theName the the name
   * @param theArgTypes the the arg types
  ...
  /**
   * Checks if is optional arg.
   *
   * @param argType the arg type
   * @return true, if is optional arg
   */
  ...
  /**
   * Checks if is output arg.
   *
   * @param argType the arg type
   * @return true, if is output arg
   */
  ...
  /**
   * Gets the variable typename.
   *
   * @param type the type
   * @return the variable typename
   */
