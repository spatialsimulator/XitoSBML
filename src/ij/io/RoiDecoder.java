...
public class RoiDecoder {
	...
	/**
	 * Gets the stroke width and color.
	 *
	 * @param roi the roi
	 * @param hdr2Offset the hdr 2 offset
	 * @return the stroke width and color
	 */
