...
public class Menus {
	 ...
	 *
	 * @param ijInstance the ij instance
	 * @param appletInstance the applet instance
	 */
	...
	/**
	 * Adds the plugin separator if needed.
	 *
	 * @param menu the menu
	 * @return the int
	 */
	...
	/**
	 * Gets the jar file for menu entry.
	 *
	 * @param menuEntry the menu entry
	 * @return the jar file for menu entry
	 */
	 ...
	 * @param readFromProps the read from props
	 * @return the menu
	 */
	...
	/**
	 * Gets the plugins submenu.
	 *
	 * @param submenuName the submenu name
	 * @return the plugins submenu
	 */
	...
	/**
	 * Gets the submenu name.
	 *
	 * @param jarPath the jar path
	 * @return the submenu name
	 */
	 ...
	 *
	 * @param name the name
	 * @param hasUnderscore the has underscore
	...
	/**
	 * Gets the macros menu.
	 *
	 * @return the macros menu
	 */
	...
	/**
	 * Checks if is color lut.
	 *
	 * @param imp the imp
	 * @return true, if is color lut
	 */
	...
	/**
	 * Gets the save as menu.
	 *
	 * @return the save as menu
	 */
