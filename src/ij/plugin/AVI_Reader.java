...
public class AVI_Reader extends VirtualStack implements PlugIn {
   ...
   //the input file
	...
	/** The dw stream length. */
	private	 int			   dwStreamLength;
	
	/** The dw stream suggested buffer size. */
	private	 int			   dwStreamSuggestedBufferSize;
	
	/** The dw stream quality. */
	private	 int			   dwStreamQuality;
	
	/** The dw stream sample size. */
	 ...
	 * @param flipVertical the flip vertical
	 ...
	 * @param endPosition the end position
	 * @param throwNotFoundException the throw not found exception
	 * @return the long
	 * @throws Exception the exception
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	 ...
	 * @param rawOffset the raw offset
	 * @param pixels the pixels
	 * @param shortOffset the short offset
	 * @param w the w
	 */
	 ...
	 * @param rawOffset the raw offset
	 * @param pixels the pixels
	 * @param intOffset the int offset
	 * @param w the w
	 */
	 ...
	 *
	 * @param rawData the raw data
	 * @param cPixels the c pixels
	 * @param topDown the top down
	 */
	 ...
	 *
	 * @param imp the new frames per second
	 */
	 ...
	 * Frame label.
	 *
	 * @param timeMicroSec the time micro sec
	 * @return the string
	 */
	...
	/** The Constant HUFFMAN_LENGTH. */
	final private static int HUFFMAN_LENGTH = 420;

	/**
	 * The Class raInputStream.
	 */
	class raInputStream extends InputStream {
		 ...
		 *
		 * @param rFile the r file
		 * @param readableSize the readable size
		 * @param fixMJPG the fix MJPG
		 * @throws IOException Signals that an I/O exception has occurred.
		 */
	 ...
	 * Display dialog.
	 *
	 * @param displayDialog the display dialog
	 */
