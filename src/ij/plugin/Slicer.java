...
public class Slicer implements PlugIn, TextListener, ItemListener {
	 ...
	 * Gets the size.
	 *
	 * @param inSpacing the in spacing
	 * @param outSpacing the out spacing
	...
	/**
	 * Gets the output stack size.
	 *
	 * @param inSpacing the in spacing
	 * @param outSpacing the out spacing
	 * @param count the count
	 * @return the output stack size
	 */
