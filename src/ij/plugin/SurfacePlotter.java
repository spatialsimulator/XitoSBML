...
public class SurfacePlotter implements PlugIn {
	 ...
	 * @param offsetXDirection the offset X direction
	 * @param offsetYDirection the offset Y direction
	 ...
	 * Clear above profile.
	 *
	 * @param ipProfile the ip profile
	 * @param profile the profile
	 * @param width the width
	 * @param yinc2 the yinc 2
	 */
