...
public class ContrastEnhancer implements PlugIn, Measurements {
	...
	/** The classic equalization. */
	boolean classicEqualization;
	
	/** The stack size. */
	int stackSize;
	
	/** The update selection only. */
	...
	/**
	 * Sets the process stack.
	 *
	 * @param processStack the new process stack
	 */
	...
	/**
	 * Sets the use stack histogram.
	 *
	 * @param useStackHistogram the new use stack histogram
	 */
