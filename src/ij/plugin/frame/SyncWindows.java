...
public class SyncWindows extends PlugInFrame implements
	...
	/**
	 * Instantiates a new sync windows.
	 *
	 * @param s the s
	 */
...
//			  g.drawRect(x-SZ,y-SZ,RSZ,RSZ);
	 ...
	 *
	 * @param n the n
	 * @return the image title from vector
	 */
 ...
 */	   
	...
	/**
	 * Gets the single instance of SyncWindows.
	 *
	 * @return single instance of SyncWindows
	 */
