...
public class RoiManager extends PlugInFrame implements ActionListener, ItemListener, MouseListener, MouseWheelListener, ListSelectionListener {
	...
	/**
	 * Instantiates a new roi manager.
	 */
	 ...
	 * Adds the roi.
	 *
	 * @param promptForName the prompt for name
	 ...
	 * @param appendResults the append results
	 * @return the results table
	 */
	 ...
	 *
	 * @return single instance of RoiManager
	 */
	 ...
	 *
	 * @return the selected rois as array
	 */
	 ...
	 *
	 * @param name the name
	 * @param saveSelected the save selected
	 * @return true, if successful
	 */
	 ...
	 *
	 * @param indexes the new selected indexes
	 */
