...
public class ThresholdAdjuster extends PlugInDialog implements PlugIn, Measurements,
	...
	/**
	 * Instantiates a new threshold adjuster.
	 */
	 ...
	 *
	 * @param imp the imp
	 * @param enableAutoThreshold the enable auto threshold
