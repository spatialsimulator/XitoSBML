...
public class ColorThresholder extends PlugInFrame implements PlugIn, Measurements,
 ActionListener, AdjustmentListener, FocusListener, ItemListener, Runnable{
	...
	/**
	 * Instantiates a new color thresholder.
	 */
	...
	/* (non-Javadoc)
	 * @see ij.plugin.frame.PlugInFrame#focusGained(java.awt.event.FocusEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see ij.plugin.frame.PlugInFrame#focusLost(java.awt.event.FocusEvent)
	 */
