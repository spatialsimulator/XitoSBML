...
public class ContrastAdjuster extends PlugInDialog implements Runnable,
	...
	/**
	 * Instantiates a new contrast adjuster.
	 */
	...
	/* (non-Javadoc)
	 * @see ij.plugin.frame.PlugInDialog#run(java.lang.String)
	 */
	...
	/**
	 * Gets the 16 bit range index.
	 *
	 * @return the 16 bit range index
	 */
	...
	/* (non-Javadoc)
	 * @see ij.plugin.frame.PlugInDialog#windowActivated(java.awt.event.WindowEvent)
	 */
