...
public class RGBStackMerge implements PlugIn {
	...
	/** The auto fill disabled. */
	private boolean autoFillDisabled;
	
	/** The first channel name. */
	 ...
	 * @param keepSourceImages the keep source images
	...
	public void mergeStacks() {
	 ...
	 /**
 	 * Gets the initial names.
 	 *
 	 * @param titles the titles
 	 * @return the initial names
 	 */
	 ...
	 *
	 * @param images the images
	 * @param createComposite the create composite
	 * @return the image plus
	 */
