...
public class FFTFilter implements  PlugInFilter, Measurements {
	 ...
	 *
	 * @param ip the ip
	 * @param filterLarge the filter large
	 * @param filterSmall the filter small
	 * @param stripesHorVert the stripes hor vert
	 * @param scaleStripes the scale stripes
	 */
	/*
