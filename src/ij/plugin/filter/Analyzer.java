...
public class Analyzer implements PlugInFilter, Measurements {
	 ...
	 *
	 * @return true, if is redirect image
	 */
	 ...
	 *
	 * @param imp the new redirect image
	 */
	...
	/**
	 * Gets the redirect image or stack.
	 *
	 * @param cimp the cimp
	 * @return the redirect image or stack
	 */
	...
	/**
	 * Gets the redirect stats.
	 *
	 * @param measurements the measurements
	 * @param roi the roi
	 * @return the redirect stats
	 */
	...
	*/
	...
	/**
	 * Sets the unsaved measurements.
	 *
	 * @param b the new unsaved measurements
	 */
	 ...
	 *
	 * @param decimalPlaces the new precision
	 */
