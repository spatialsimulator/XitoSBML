...
public class BackgroundSubtracter implements ExtendedPlugInFilter, DialogListener {
     ...
     * @param useParaboloid the use paraboloid
     ...
     * @param doPresmooth the do presmooth
     * @param correctCorners the correct corners
     */
     ...
     *      </pre>
     *
     * @param smallIndices the small indices
     * @param weights the weights
     * @param length the length
     * @param smallLength the small length
     * @param shrinkFactor the shrink factor
     */
