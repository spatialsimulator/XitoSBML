...
public class PlugInFilterRunner implements Runnable, DialogListener {
	 ...
	 * @param ip the ip
	 * @param fp the fp
	 * @param snapshotDone the snapshot done
	 */
	 ...
	 *
	 * @param roisForThread the rois for thread
	 */
