...
public class RankFilters implements ExtendedPlugInFilter, DialogListener {
	 ...
	 *
	 * @param ip the ip
	 * @param lineRadii the line radii
	 * @param filterType the filter type
	 * @param minMaxOutliersSign the min max outliers sign
	 * @param threshold the threshold
	 * @param colorChannel the color channel
	 * @param aborted the aborted
	 */
	 ...
	 * @param cacheWidth the cache width
	 * @param cacheHeight the cache height
	 * @param filterType the filter type
	 * @param minMaxOutliersSign the min max outliers sign
	 * @param threshold the threshold
	 * @param colorChannel the color channel
	 * @param yForThread the y for thread
	 ...
	 * @param cache the cache
	 * @param cachePointers the cache pointers
	 * @param kNPoints the k N points
	 * @param cacheLineP the cache line P
	 * @param roi the roi
	 * @param y the y
	 * @param sums the sums
	 * @param medianBuf1 the median buf 1
	 * @param medianBuf2 the median buf 2
	 * @param minMaxOutliersSign the min max outliers sign
	 * @param maxValue the max value
	 * @param isFloat the is float
	 * @param filterType the filter type
	 * @param smallKernel the small kernel
	 * @param sumFilter the sum filter
	 * @param minOrMax the min or max
	 * @param minOrMaxOrOutliers the min or max or outliers
	 * @param threshold the threshold
	 */
	 ...
	 * @param roiY the roi Y
	 * @param xminInside the xmin inside
	 * @param widthInside the width inside
	 * @param cache the cache
	 * @param cacheWidth the cache width
	 * @param cacheHeight the cache height
	 ...
	 *
	 * @param pixels the pixels
	 * @param pixelLineP the pixel line P
	 * @param xminInside the xmin inside
	 * @param widthInside the width inside
	 * @param cache the cache
	 * @param cacheLineP the cache line P
	 ...
	 * @param xCache0 the x cache 0
	 * @param kernel the kernel
	 * @param aboveBuf the above buf
	 * @param belowBuf the below buf
	 * @param kNPoints the k N points
