...
public class EDM implements ExtendedPlugInFilter {
     ...
     * Edm line.
     *
     * @param bPixels the b pixels
     * @param fPixels the f pixels
     * @param pointBufs the point bufs
     * @param width the width
     * @param offset the offset
     * @param y the y
     * @param backgroundValue the background value
     * @param yDist the y dist
     */
     ...
     * @param pPrev the prev
     * @param pDiag the diag
     * @param x the x
     * @param y the y
     * @param distSqr the dist sqr
     * @return the float
     */
     ...
     * @param floatEdm the float edm
     * @param mask the mask
     * @param resetOnThis the reset on this
     */
