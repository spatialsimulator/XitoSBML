...
public class ZProjector implements PlugIn {
    ...
    /**
     * Instantiates a new z projector.
     */
    public ZProjector() {
    }
     ...
     *
     * @param slice the new start slice
     */
     ...
     * Sets the stop slice.
     *
     * @param slice the new stop slice
     */
	 ...
	 * Sets the method.
	 *
	 * @param projMethod the new method
	 */
	 ...
	 * Do RGB projection.
	 *
	 * @param handleOverlay the handle overlay
	 */
	 ...
	 *
	 * @param allTimeFrames the all time frames
	 */
	...
	private void doHSRGBProjection(ImagePlus rgbImp) {
 	...
 	/**
	  * Gets the ray function.
	  *
	  * @param method the method
	  * @param fp the fp
	  * @return the ray function
	  */
	...
	*/
    ...
    class AverageIntensity extends RayFunction {
		...
		/* (non-Javadoc)
		 * @see ij.plugin.ZProjector.RayFunction#projectSlice(byte[])
		 */
		...
		/* (non-Javadoc)
		 * @see ij.plugin.ZProjector.RayFunction#projectSlice(short[])
		 */
		...
		/* (non-Javadoc)
		 * @see ij.plugin.ZProjector.RayFunction#projectSlice(float[])
		 */
		...
		/* (non-Javadoc)
		 * @see ij.plugin.ZProjector.RayFunction#postProcess()
		 */
		public void postProcess() {
			float fnum = num;
	    	for(int i=0; i<len; i++)
