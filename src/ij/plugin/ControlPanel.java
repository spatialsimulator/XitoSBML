...
public class ControlPanel implements PlugIn {
   ...
   * @param source String to be parsed in a tree path; must be composed of tokens delimited by "/"
	...
	/**
	 * Sets the double click.
	 *
	 * @param dc the new double click
	 */
	void setDoubleClick(boolean dc) {requireDoubleClick = dc;}

	/**
	 * Checks for panel for node.
	 *
	 * @param node the node
	 * @return true, if successful
	 */
	...
	/**
	 * Gets the panel for node.
	 *
	 * @param node the node
	 * @return the panel for node
	 */
	...
	/**
	 * Gets the tree commands.
	 *
	 * @return the tree commands
	 */
	...
	/**
	 * Gets the visible panels count.
	 *
	 * @return the visible panels count
	 */
	...
	/**
	 * Sets the expanded state property.
	 *
	 * @param item the new expanded state property
	 */
	...
	/**
	 * Checks for expanded state property.
	 *
	 * @param item the item
	 * @return true, if successful
	 */
	...
	/**
	 * Sets the panel showing property.
	 *
	 * @param item the new panel showing property
	 */
	...
	/**
	 * Checks for panel showing property.
	 *
	 * @param item the item
	 * @return true, if successful
	 */
