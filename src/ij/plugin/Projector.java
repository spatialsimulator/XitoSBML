...
public class Projector implements PlugIn {
	...
	/** The transparency lower. */
	private int transparencyLower = 1;
	
	/** The transparency upper. */
	 ...
	 * Allocate arrays.
	 *
	 * @param nProjections the n projections
	 * @param projwidth the projwidth
	 * @param projheight the projheight
	 */
	 ...
	 * @param zcenter the zcenter
	 * @param projwidth the projwidth
	 * @param projheight the projheight
	 * @param costheta the costheta
	 * @param sintheta the sintheta
	 */
