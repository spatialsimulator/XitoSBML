...
public class IJ {
	...
	/** The redirect error messages. */
	private static boolean redirectErrorMessages;
	
	/** The suppress plugin not found error. */
	 ...
	 * Inits the.
	 *
	 * @param imagej the imagej
	 * @param theApplet the the applet
	 */
 ...
 */
	 ...
	 *
	 * @return true, if is results window
	 */
	 ...
	 *
	 * @param imp the imp
	 * @param startNanoTime the start nano time
	 * @return the string
	 */
	 ...
	 * @param upperThresold the upper thresold
	 */
