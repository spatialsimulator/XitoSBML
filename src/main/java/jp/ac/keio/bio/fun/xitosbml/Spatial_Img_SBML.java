 ...
 *
 * This class calls "run Spatial Image SBML plugin" from ImageJ (XitoSBML). This
 * class is an implementation of XitoSBML as an ImageJ plugin. The run(String)
 * method will call
 * jp.ac.keio.bio.fun.xitosbml.xitosbml.MainImgSpatial#run(java.lang.String).
 * Once registered in src/main/resources/plugins.config, the run() method can be
 * called from the ImageJ menu. Date Created: Jun 17, 2015
 *
...
public class Spatial_Img_SBML extends Spatial_SBML {
	...
	/**
	 * Launch XitoSBML as ImageJ plugin. See
	 * {@link jp.ac.keio.bio.fun.xitosbml.xitosbml.MainImgSpatial#run(java.lang.String)}
	 * for implementation.
	 * 
	...
	/**
	 * Example main() method which will launch ImageJ and call "run Spatial Image
	 * SBML plugin".
	 * 
